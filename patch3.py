...
with open('MainWindow.xaml.cs', 'r', encoding='big5') as f:
    content = f.read()
...
'''
# inject comp_target after OnClosing
...
with open('MainWindow.xaml.cs', 'w', encoding='big5') as f:
    f.write(content)
